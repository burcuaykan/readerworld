...
import AddBook from './components/pages/add-book-page/add-book';
import UploadImage from './components/pages/upload-image-page/upload-image';
    ...
    return (
      <BrowserRouter>
        <Switch>
          ...
          <Route exact path='/upload-image' component={UploadImage}></Route>
